...
// ロゴの表示設定
pc_logo.style.width="100%";pc_logo.setAttribute("id","pc_logo");pc_logo.style.height="32px";
pc_logo.style.width="100%";pc_logo.setAttribute("id","sp_logo");pc_logo.style.height="32px";
