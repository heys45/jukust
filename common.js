...
document.querySelectorAll(".super-navbar__logo-image picture")[0].remove();
...
var notion_header_a = document.querySelectorAll(".super-navbar a")[0];
notion_header_a.style.width="calc(100% - 100px)";
notion_header_a.style.overflowX="hidden";
