...
console.log(button_area.getElementsByTagName("img")[1]);
console.log(button_area.getElementsByTagName("picture")[1]);
var button_icon=button_area.getElementsByTagName("img")[1];
